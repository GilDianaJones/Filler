...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/01/31 12:51:12 by gthomas           #+#    #+#             */
/*   Updated: 2017/01/31 13:49:51 by gthomas          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		algo_p1_dir_1(t_filler *filler)
{
	if (filler->dir == 1)
	{
		...
		while (filler->coor_y >= 0)
		{
			...
			{
				get_n_c_pce_1(filler, filler->pce_x, filler->pce_y - 1);
				get_n_c_p1_1(filler, filler->coor_x, filler->coor_y);
			}
...
void		algo_p1_dir_2(t_filler *filler)
{
	if (filler->dir == 2)
	{
		...
		get_n_c_p1_2(filler, -1, filler->map_y - 1);
		while (filler->coor_y >= 0)
		{
			if (filler->coor_pce_y >= 0 && !fit_in_map(filler))
			...
			{
				get_n_c_pce_2(filler, filler->pce_x, 0);
				get_n_c_p1_2(filler, filler->coor_x, filler->coor_y);
			}
			if (fit_in_map(filler))
			{
				if (place_piece(filler))
...
void		algo_p1_dir_3(t_filler *filler)
{
	if (filler->dir == 3)
	{
		...
		get_n_c_p1_3(filler, filler->map_x, 0);
		while (filler->coor_y >= 0)
		{
			if (filler->coor_pce_y >= 0 && !fit_in_map(filler))
			...
			{
				get_n_c_pce_3(filler, -1, filler->pce_y - 1);
				get_n_c_p1_3(filler, filler->coor_x, filler->coor_y);
			}
			if (fit_in_map(filler))
			{
				if (place_piece(filler))
...
void		algo_p1_dir_4(t_filler *filler)
{
	if (filler->dir == 4)
	{
		...
		get_n_c_p1_4(filler, filler->map_x, filler->map_y - 1);
		while (filler->coor_y >= 0)
		{
			if (filler->coor_pce_y >= 0 && !fit_in_map(filler))
			...
			{
				get_n_c_pce_4(filler, -1, 0);
				get_n_c_p1_4(filler, filler->coor_x, filler->coor_y);
			}
			if (fit_in_map(filler))
			{
				if (place_piece(filler))
